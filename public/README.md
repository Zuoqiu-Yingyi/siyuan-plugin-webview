...
- Open in a Tab
  ...
  - `Shortcut Keys`
    ...
    - This is a group of switches.
    - Default status: _left mouse button single click_
    - Only available when the `Enable` switch in the `General Settings` tab is turned on.
...
- Open in a Window
  ...
  - `Shortcut Keys`
    ...
    - This is a group of switches.
    - Default status: _middle mouse button click_
    - Only available when the `Enable` switch in the `General Settings` tab is turned on.
  ...
  - `SiYuan Editor`
    ...
    - `Editor Type`
      ...
      - Default status: _Mobile Editor_
